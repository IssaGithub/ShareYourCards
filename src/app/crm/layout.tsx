...
const nav = [
  ...
  { href: "/crm/auftraege", label: "Aufträge" },
];
      ...
      <div className="flex min-h-screen">
        ...
        >
          <div className="flex h-16 items-center justify-between border-b border-line px-5">
            <Link href="/crm" className="font-display text-lg font-bold">
              MH · CRM
            </Link>
            <button
              type="button"
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-20 flex h-16 items-center gap-4 border-b border-line bg-bg/90 px-5 backdrop-blur">
            ...
            <div className="flex-1">
              ...
              <p className="font-display text-sm font-bold">MOTORHALLE</p>
            </div>
            <Link href="/termin" className="btn-secondary !py-2 !px-3 text-xs">
              + Online-Termin
            </Link>
          </header>
