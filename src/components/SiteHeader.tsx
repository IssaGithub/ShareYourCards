...
export function SiteHeader() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-line/60 bg-bg/85 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5">
        ...
        <nav className="hidden items-center gap-8 md:flex">
          ...
          <Link href="/anfrage" className="btn-primary !py-2.5 !px-4 text-sm">
            Gutachten anfordern
          </Link>
        </nav>
